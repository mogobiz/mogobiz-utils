...
object RSA {
  ...
  def main(args: Array[String]) {
    var dataEncoded64: String = RSA.encrypt(
        "hayssam@saleh.fr;customer_email;1234567890123456;AZERAZERAZERAZERAZERAZER",
        new FileInputStream("/Users/hayssams/git/mogopay-core/mogopay/web-app/WEB-INF/secretkeys/public.key"))
    System.out.println(dataEncoded64)
    System.out.println("^^^^^^^^^^^^")
    var data: String = RSA.decrypt(
        "D3cHhsyst5__sz1Nh75Xk45EGYKFIn94EJb3xH585b0zsmZYjkDlXHo-UhVgkGqpw-aMldc5TDYbv0V54Tvmwbh9zBluhzkN9YN0ZAMaZ38DAKlVpee8bY-HQeB2Kgm9wxvDa_62XddvMIDM8ef4DrqWWhXCoO6lj-NiAha_oSzxTb42uAunBFM4Msl8pe0ctDUtyU5sIjTO4gjvjwQeJVKpRPtuGj4TpNANJaFGNbyiEgU-8ue6iD2oTdTTHwy4XOIlxDShgPkuKrzkjYMoHAr9SSCwV_HaxPJj9zL2PKu_GsV9D9isukI1F1jjdL9jt9-HF8PQGHMg2CfHka_oMA==",
    ...
    val data2: Array[Byte] = RSA.encrypt(
        "1245673241657342671437432714632".getBytes,
        new FileInputStream("/Users/hayssams/git/mogopay-core/mogopay/web-app/WEB-INF/secretkeys/public.key"))
    val data3: Array[Byte] = RSA.decrypt(
        data2,
        new FileInputStream("/Users/hayssams/git/mogopay-core/mogopay/web-app/WEB-INF/secretkeys/private.key"))
    System.out.println(new String(data3))
    dataEncoded64 = RSA.encrypt(
        "demande;1379067702831;039142286;yoann.baudy@ebiznext.com",
        new FileInputStream("/Users/hayssams/git/mogopay-core/mogopay/web-app/WEB-INF/secretkeys/public.key"))
    System.out.println("******")
    System.out.println(dataEncoded64)
    data = RSA.decrypt(
        "g_U1K1bLqGRuz1v66Al7pcCa_TgwO48kdhh7hAcBGrOFCKw-08f-00okShMoBrvAo26zEFl2sDicr_f_AqRZ7LtM7ngzCpYU7Z-HRk7o75-IunVvtuo4hyY_bN3Q-wdnRPgsO_0-L6_q9-INL5CLcbwQ0pbP2NS4gcJrQ-Gn18vyvLWJVHNHffbiVW3mkzsJngAe8IMSsXhvWaMg0tR9PDnR_C78720HlGS5BMgabUTIsx5orGoUNBEjYVVMWwZtrdhTphm1XRgQExN8YrYqieoCuTdjUlQvqA80jjM0df73qOke163f1W1Jpzbvk4FuUW8a8DXVtJ0MdbUladhj2A==",
        new FileInputStream("/Users/hayssams/git/mogopay-core/mogopay/web-app/WEB-INF/secretkeys/private.key"))
    System.out.println(dataEncoded64 + "/" + data)
